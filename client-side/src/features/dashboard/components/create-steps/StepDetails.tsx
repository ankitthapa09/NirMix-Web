...
//           label: "House Type",
//           type: "card-select",
//           options: ["Independent", "Villa", "Duplex", "Bungalow", "Farm House"],
//           required: true,
//         },
//         {
//           key: "beds",
...
//           options: ["Pooja Room (Mandir)", "Study / Office Room", "Store Room", "Servant Quarter", "Kitchenette", "Guard Room"],
//           required: false,
//         },
//       ],
//     },
...
//           type: "dropdown",
//           options: ["Brand New", "1-5 Years", "5-10 Years", "10+ Years"],
//           placeholder: "Select property age",
//           dependsOn: { field: "constructionStatus", operator: "notEquals", value: "Under Construction" },
//           required: true,
//         },
//         {
//           key: "possessionDate",
...
//           dependsOn: { field: "constructionStatus", operator: "equals", value: "Under Construction" },
//           required: true,
//         },
//         {
//           key: "facing",
...
//           label: "Overlooking",
//           type: "chip-multiselect",
//           options: ["Main Road", "Park", "Garden", "Pool", "Mountain View"],
//           required: false,
//         },
//         {
//           key: "vastuCompliant",
...
//           label: "RERA ID",
//           type: "text",
//           placeholder: "e.g. RERA-NP-12345",
//           dependsOn: { field: "reraRegistered", operator: "equals", value: true },
//           required: true,
//         },
//       ],
//     },
...
//         {
//           key: "furnishingItems",
//           label: "Furnishing Checklist",
//           type: "chip-multiselect",
//           options: ["Bed", "Sofa", "Dining Table", "AC", "Wardrobe", "TV", "Refrigerator", "Washing Machine", "Modular Kitchen", "Geyser"],
//           dependsOn: { field: "furnishing", operator: "notEquals", value: "Unfurnished" },
//           required: false,
//         },
//       ],
//     },
...
//           placeholder: "Select terrace access",
//           required: false,
//         },
//         {
//           key: "servantQuarters",
...
//         {
//           key: "amenities",
//           label: "Amenities Checklist",
//           type: "chip-multiselect",
//           options: ["Power Backup", "24x7 Water", "Borewell", "Rainwater Harvesting", "Security/CCTV", "Gated Community", "Solar Panel", "Intercom", "Fire Safety", "Compound Wall", "Visitor Parking"],
//           required: false,
//         },
//       ],
//     },
...
//           type: "autocomplete",
//           placeholder: "Type or select society name (e.g. Civil Homes)",
//           required: true,
//         },
//         {
//           key: "totalTowers",
...
//           type: "number",
//           placeholder: "e.g. 4",
//           dependsOn: { field: "societyName", operator: "truthy" },
//           required: false,
//         },
//         {
//           key: "floorsPerTower",
...
//         {
//           key: "visitorParking",
//           label: "Visitor Parking Available",
//           type: "toggle",
//           required: false,
//         },
//       ],
...
//           type: "chip-multiselect",
//           options: [
//             "Clubhouse", "Pool", "Gym", "Kids Play Area", "Jogging Track",
//             "Indoor Games", "Banquet Hall", "Amphitheater", "Tennis/Badminton Court",
//             "Yoga Deck", "Senior Citizen Sitout", "EV Charging", "Intercom",
//             "Rainwater Harvesting", "STP", "Gas Pipeline", "Fire Safety", "CCTV",
//             "Gated Community", "24x7 Power Backup", "Multipurpose Hall"
//           ],
//           required: false,
//         },
//       ],
...
//         {
//           key: "maintenanceCost",
//           label: "Monthly Maintenance Cost (Rs)",
//           type: "number",
...
//           label: "Pet Policy",
//           type: "dropdown",
//           options: ["Allowed", "Not Allowed", "Restrictions Apply"],
...
//           label: "Water Source",
//           type: "dropdown",
//           options: ["Municipal Supply (KUKL Tap)", "Groundwater (Boring / Well)", "Private Tanker Delivery", "Mixed Sources"],
...
//           type: "autocomplete",
//           placeholder: "e.g. Lalitpur Heights",
//           required: true,
//         },
//         {
//           key: "floor",
...
//       fields: [
//         {
//           key: "waterStorageType",
//           label: "Water Storage",
//           type: "dropdown",
//           options: ["Overhead Tank", "Underground Sump", "Both", "None"],
...
//           label: "Plot Type",
//           type: "card-select",
//           options: ["Residential", "Commercial", "Agricultural", "Industrial", "Farm House"],
//           required: true,
//         },
//         {
//           key: "landArea",
...
//         {
//           key: "plotNumber",
//           label: "Plot / Survey Number (Kitta No)",
//           type: "text",
//           placeholder: "e.g. 452",
//           required: false,
//         },
...
//           label: "Plot Shape",
//           type: "dropdown",
//           options: ["Rectangular", "Square", "Triangular", "Irregular"],
...
//           type: "dropdown",
//           options: ["Blacktopped (Kaalo Patre)", "Concrete Paved (Dhalai)", "Gravelled", "Dirt Road (Kuccha / Mato)"],
...
//           type: "dropdown",
//           options: ["Kathmandu Metropolitan (KMC)", "Lalitpur Metropolitan (LMC)", "Bhaktapur Municipality", "KVDA (Valley Development)", "Local Ward Office (Wada Karyalaya)", "Others"],
...
//           label: "Land Use Zone",
//           type: "dropdown",
//           options: ["Residential", "Commercial", "Agricultural", "Industrial", "Mixed"],
//           placeholder: "Select land use zone",
//           required: false,
//         },
//         {
//           key: "titleType",
//           label: "Title Type",
//           type: "dropdown",
//           options: ["Lalpurja (Freehold)", "Leasehold (Contractual)", "Guthi Land (Trust)", "Mohi Rights Registered"],
...
//           type: "dropdown",
//           options: ["Converted", "Pending", "Not Applicable"],
//           placeholder: "Select conversion status",
//           dependsOn: { field: "plotType", operator: "equals", value: "Agricultural" },
//           required: false,
//         },
//         {
//           key: "khataType",
//           label: "Khata Type",
//           type: "dropdown",
//           options: ["Single ownership", "Joint ownership"],
//           placeholder: "Select ownership type",
//           required: false,
//         },
//         {
//           key: "encumbranceCertificate",
//           label: "Encumbrance Certificate (Clear of mortgage)",
//           type: "toggle",
//           required: false,
//         },
//       ],
...
//           label: "Soil Type",
//           type: "dropdown",
//           options: ["Sandy", "Clay", "Loamy", "Alluvial", "Black Soil"],
...
//           type: "dropdown",
//           options: ["Canal", "Borewell Supply", "Rainfed", "River Access", "None"],
...
//           label: "Sharing Type",
//           type: "card-select",
//           options: ["Single", "Double", "Triple", "Dorm"],
//           required: true,
//         },
//         {
//           key: "beds",
...
//         {
//           key: "furnishingItems",
//           label: "Furnishing Inclusions",
//           type: "chip-multiselect",
//           options: ["Bed", "Mattress", "Wardrobe", "Study Table", "Chair", "Fan", "Heater", "Curtains"],
//           required: false,
//         },
//       ],
//     },
...
//         },
//         {
//           key: "occupationPreference",
//           label: "Occupation Preference",
//           type: "dropdown",
//           options: ["Student", "Professional", "Any"],
...
//           type: "dropdown",
//           options: ["Veg Only", "Non-Veg Allowed", "Any"],
...
//           label: "Meals Service",
//           type: "dropdown",
//           options: ["Not Included", "Veg Included", "Non-Veg Included", "All Meals Provided"],
//           placeholder: "Select meals option",
//           required: true,
//         },
//         {
//           key: "mealsIncluded",
...
//           dependsOn: { field: "meals", operator: "notEquals", value: "Not Included" },
//           required: true,
//         },
//         {
//           key: "housekeeping",
//           label: "Housekeeping / Room Cleaning",
//           type: "toggle",
//           required: false,
//         },
//         {
//           key: "laundry",
//           label: "Laundry Service / Washing Machine",
//           type: "toggle",
//           required: false,
//         },
//         {
...
//           type: "dropdown",
//           options: ["Included in rent", "Extra - Submeter read", "Shared bill"],
//           placeholder: "Select electricity policy",
//           required: false,
//         },
//         {
//           key: "roWater",
//           label: "Drinking Water (RO Filtered)",
//           type: "toggle",
//           required: false,
//         },
//         {
//           key: "powerBackup",
//           label: "Power Backup (UPS/Generator)",
//           type: "toggle",
//           required: false,
//         },
//         {
...
//           type: "chip-multiselect",
//           options: ["Living Room", "Kitchen", "Dining Area", "Terrace", "Gym"],
//           required: false,
//         },
//       ],
//     },
...
//           label: "Curfew Time",
//           type: "dropdown",
//           options: ["No Curfew", "9 PM", "10 PM", "11 PM", "Midnight"],
//           placeholder: "Select curfew time",
//           required: false,
//         },
//         {
//           key: "visitorsAllowed",
...
//           type: "dropdown",
//           options: ["Yes - anytime", "No visitors", "Day visits only", "Same-gender only"],
//           placeholder: "Select visitors policy",
//           required: false,
//         },
//         {
//           key: "smokingDrinkingAllowed",
//           label: "Smoking & Drinking Allowed",
//           type: "toggle",
//           required: false,
//         },
//         {
...
//         {
//           key: "seatingCapacity",
//           label: "Seating Capacity (Workstations)",
//           type: "number",
//           placeholder: "e.g. 25",
//           required: false,
//         },
...
//           label: "Washrooms",
//           type: "dropdown",
//           options: ["Private", "Common", "Both Private & Common"],
//           placeholder: "Select washroom configuration",
//           required: false,
//         },
//         {
//           key: "reception",
//           label: "Dedicated Reception Area",
//           type: "toggle",
//           required: false,
//         },
//         {
...
//         {
//           key: "serverRoom",
//           label: "Dedicated Server Room",
//           type: "toggle",
//           required: false,
//         },
//         {
//           key: "storageRoom",
//           label: "Storage / Archive Room",
//           type: "toggle",
//           required: false,
//         },
//       ],
...
//         {
//           key: "powerBackupKva",
//           label: "Power Backup capacity (KVA)",
//           type: "number",
//           placeholder: "e.g. 15",
//           required: false,
//         },
...
//         {
//           key: "cablingType",
//           label: "IT Cabling Type",
//           type: "dropdown",
//           options: ["CAT6 structured cabling", "Fiber Optic", "Standard copper cabling", "Underfloor cabling"],
//           placeholder: "Select cabling type",
//           required: false,
//         },
//         {
//           key: "fireSafetyCompliance",
//           label: "Fire Safety Compliance (Sprinklers/Exits)",
//           type: "toggle",
//           required: false,
//         },
//         {
//           key: "access24x7",
//           label: "24/7 Building Access",
//           type: "toggle",
//           required: false,
//         },
//         {
...
//         {
//           key: "workstations",
//           label: "Workstations Provided",
//           type: "number",
//           placeholder: "e.g. 20",
//           dependsOn: { field: "officeType", operator: "equals", value: "Fully Furnished" },
//           required: true,
//         },
//         {
//           key: "furnishingItems",
...
//           type: "chip-multiselect",
//           options: ["Executive Desks", "Ergonomic Chairs", "Filing Cabinets", "Visitor Sofa", "Boardroom Table"],
//           dependsOn: { field: "officeType", operator: "equals", value: "Fully Furnished" },
//           required: false,
//         },
//         {
//           key: "acUnitsCount",
//           label: "AC Split Units Count",
//           type: "stepper",
//           dependsOn: { field: "officeType", operator: "equals", value: "Fully Furnished" },
//           required: false,
//           min: 0,
...
//           label: "IT Inclusions",
//           type: "chip-multiselect",
//           options: ["Server Rack", "Network Switches", "Wifi Routers", "Online UPS", "Projector / Display Screen"],
//           dependsOn: { field: "officeType", operator: "equals", value: "Fully Furnished" },
//           required: false,
//         },
//       ],
...
//           label: "Suitable For",
//           type: "chip-multiselect",
//           options: ["IT/ITES Company", "BPO/Call Center", "Bank / Financial Institution", "Co-working Space", "Startup Office", "Corporate HQ", "Healthcare Clinic", "Educational Institution"],
//           required: false,
//         },
//       ],
//     },
...
//           label: "Floor Level",
//           type: "dropdown",
//           options: ["Ground Floor", "1st Floor", "2nd Floor", "Basement", "Others"],
//           placeholder: "Select floor level",
//           required: true,
//         },
//         {
//           key: "washroom",
//           label: "Private Washroom Available",
//           type: "toggle",
//           required: false,
//         },
//         {
//           key: "storageBackroom",
//           label: "Storage Backroom Available",
//           type: "toggle",
//           required: false,
//         },
//       ],
...
//           type: "card-select",
//           options: ["Bare Shell (Fixtureless)", "Has Fixtures", "Running Business"],
//           required: true,
//         },
//         {
...
//           type: "text",
//           placeholder: "e.g. Grocery, Clothing Boutique",
//           dependsOn: { field: "condition", operator: "equals", value: "Running Business" },
//           required: true,
//         },
//         {
...
//           label: "Interior Build Condition",
//           type: "dropdown",
//           options: ["Brand New (Modern)", "Well Maintained", "Needs Renovation"],
//           placeholder: "Select build condition",
//           required: false,
//         },
//       ],
//     },
...
//           type: "dropdown",
//           options: ["High Footfall (Busy Road/Mall)", "Medium Footfall", "Low Footfall"],
//           placeholder: "Select footfall level",
//           required: false,
//         },
//         {
//           key: "visibility",
...
//           type: "dropdown",
//           options: ["Direct Road Frontage", "Side Street View", "Internal Mall Unit", "Corner Visibility"],
//           placeholder: "Select visibility type",
//           required: false,
//         },
//         {
//           key: "powerLoad",
//           label: "Available Power Load (KW)",
//           type: "number",
//           placeholder: "e.g. 5",
//           required: false,
//         },
//         {
//           key: "signagePermission",
//           label: "Signage Permission Granted",
//           type: "toggle",
//           required: false,
//         },
//         {
//           key: "waterConnection",
//           label: "Water Connection Inside",
//           type: "toggle",
//           required: false,
//         },
//         {
...
//         },
//         {
//           key: "customerParkingCount",
//           label: "Customer Parking Capacity (Vehicles)",
//           type: "stepper",
//           dependsOn: { field: "customerParking", operator: "equals", value: true },
//           required: false,
//           min: 0,
//         },
//         {
//           key: "loadingUnloading",
//           label: "Dedicated Loading/Unloading Bay",
//           type: "toggle",
//           required: false,
//         },
//       ],
...
//           label: "Suitable For",
//           type: "chip-multiselect",
//           options: ["Retail Shop", "Restaurant/Café", "Salon/Spa", "Clinic / Pharmacy", "Showroom", "Warehouse / Storage", "Bank Branch / ATM", "Grocery Store / Mini Mart"],
//           required: false,
//         },
//       ],
//     },
...
//     // Auto calculate price per unit (Price/Sq.Ft or Price/Aana)
...
//       // Check specific schema required fields
...
//     `w-full px-4 py-3 rounded-lg border bg-[#F7F3EA]/70 focus:bg-[#F7F3EA] focus:outline-none text-xs text-[#342417] placeholder-[#342417]/30 italic font-semibold transition-all ${hasError ? "border-red-500 ring-1 ring-red-500" : "border-[#E0D4C5] focus:border-[#E5C158] focus:ring-1 focus:ring-[#E5C158]"
//     }`;

//   const labelStyle = "block text-[10px] font-extrabold uppercase tracking-wider text-[#5C4D3C]/70 mb-2";

//   // Dynamic field renderer
//   const renderField = (field: FieldConfig) => {
//     const hasError = !!errors[field.key];
//     const activeColor = listingType === "For Rent" ? "bg-[#24A148] text-white" : "bg-[#E5C158] text-[#342417]";
...
//               value={formData[field.key] || ""}
//               onChange={(e) => handleUpdate({ [field.key]: e.target.value })}
//               className={`w-full px-4 py-3 rounded-lg border bg-[#F7F3EA]/70 focus:bg-[#F7F3EA] focus:outline-none text-xs text-[#342417] font-semibold appearance-none cursor-pointer pr-10 ${hasError ? "border-red-500 ring-1 ring-red-500" : "border-[#E0D4C5] focus:border-[#E5C158]"
//                 }`}
//             >
...
//         return (
//           <div className="flex items-center justify-between p-1 bg-white rounded-full border border-[#E0D4C5] w-36">
//             <button
//               type="button"
//               onClick={() => handleUpdate({ [field.key]: Math.max((field.min ?? 0), numVal - 1) })}
//               className="w-8 h-8 rounded-full flex items-center justify-center bg-[#FAF6F0] hover:bg-[#EADDC9]/50 text-[#342417] transition-all cursor-pointer border border-[#E0D4C5]/40"
//             >
//               <Minus className="h-3 w-3" />
//             </button>
//             <span className="text-xs font-extrabold text-[#342417]">{numVal}</span>
//             <button
//               type="button"
...
//       case "toggle":
//         // Handles binary choices like Yes/No
//         const isTrue = !!formData[field.key];
//         const toggleOptions = field.options || ["Yes", "No"];
//         return (
//           <div className="flex p-1 bg-white rounded-full border border-[#E0D4C5] w-48">
//             <button
//               type="button"
//               onClick={() => handleUpdate({ [field.key]: true })}
//               className={`flex-1 py-1.5 text-center text-[10px] font-extrabold rounded-full transition-all cursor-pointer ${isTrue ? activeColor : "text-[#342417]/50 hover:text-[#342417]"
//                 }`}
//             >
//               {toggleOptions[0]}
//             </button>
...
//       case "card-select":
//         const activeCardStyle = listingType === "For Rent"
//           ? "border-[#A1B855] bg-[#D4E795] text-[#342417] shadow-[0_0_12px_rgba(212,231,149,0.25)]"
//           : "border-[#D4B24A] bg-[#E5C158] text-[#342417] shadow-[0_0_12px_rgba(229,193,88,0.25)]";
//         return (
...
//                   className={`flex flex-col items-start justify-between p-3.5 rounded-xl border-2 text-left transition-all duration-300 cursor-pointer h-20 ${isSelected ? activeCardStyle : "border-[#E0D4C5]/80 bg-white hover:bg-[#FAF6F0]"
//                     }`}
//                 >
//                   <Icon className={`h-4.5 w-4.5 ${isSelected ? "text-[#342417]" : "text-[#5C4D3C]/60"}`} />
//                   <span className="block text-[10px] font-extrabold tracking-tight leading-none mt-1.5 uppercase">
//                     {opt}
//                   </span>
//                 </button>
//               );
...
//         const selectedChipStyle = listingType === "For Rent"
...
//                   }}
//                   className={`px-3.5 py-1.5 rounded-full text-xs font-bold border transition-all cursor-pointer flex items-center gap-1.5 ${isChecked
//                     ? selectedChipStyle
...
//               }}
//               onBlur={() => {
//                 // Delay hiding suggestions to allow item clicks
...
//               <div className="absolute z-50 w-full mt-1 bg-white border border-[#E0D4C5] rounded-xl shadow-lg max-h-48 overflow-y-auto">
//                 {suggestions.map((sug) => (
//                   <button
//                     key={sug}
//                     type="button"
...
//                       setShowSuggestions(false);
//                     }}
//                     className="w-full text-left px-4 py-2.5 hover:bg-[#FAF6F0] text-xs font-semibold text-[#342417] transition-all"
//                   >
//                     {sug}
//                   </button>
//                 ))}
...
//             <div className="flex flex-wrap p-1 bg-white rounded-lg border border-[#E0D4C5] w-full sm:w-fit gap-1">
//               {[
...
//                     className={`px-3 py-1.5 text-center text-[10px] font-extrabold rounded-md transition-all cursor-pointer ${isSelected ? activeColor : "text-[#342417]/60 hover:text-[#342417]"
//                       }`}
//                   >
//                     {opt.label}
//                   </button>
...
//                     onChange={(e) => handleNepaleseConversion("ropani", e.target.value)}
//                     placeholder="Ropani"
//                     className="w-full px-3 py-2.5 pr-14 nm-input rounded-lg text-xs font-semibold text-right"
//                   />
...
//                     type="number"
//                     value={formData.aana || ""}
//                     onChange={(e) => handleNepaleseConversion("aana", e.target.value)}
//                     placeholder="Aana"
//                     className="w-full px-3 py-2.5 pr-12 nm-input rounded-lg text-xs font-semibold text-right"
//                   />
...
//                     onChange={(e) => handleNepaleseConversion("paisa", e.target.value)}
//                     placeholder="Paisa"
//                     className="w-full px-3 py-2.5 pr-12 nm-input rounded-lg text-xs font-semibold text-right"
//                   />
...
//                     type="number"
//                     value={formData.daam || ""}
//                     onChange={(e) => handleNepaleseConversion("daam", e.target.value)}
//                     placeholder="Daam"
//                     className="w-full px-3 py-2.5 pr-12 nm-input rounded-lg text-xs font-semibold text-right"
//                   />
...
//                     onChange={(e) => handleTeraiConversion("bigha", e.target.value)}
//                     placeholder="Bigha"
//                     className="w-full px-3 py-2.5 pr-14 nm-input rounded-lg text-xs font-semibold text-right"
//                   />
...
//                   <input
//                     type="number"
//                     value={formData.kattha || ""}
//                     onChange={(e) => handleTeraiConversion("kattha", e.target.value)}
//                     placeholder="Kattha"
//                     className="w-full px-3 py-2.5 pr-14 nm-input rounded-lg text-xs font-semibold text-right"
//                   />
...
//                     type="number"
//                     value={formData.dhur || ""}
//                     onChange={(e) => handleTeraiConversion("dhur", e.target.value)}
//                     placeholder="Dhur"
//                     className="w-full px-3 py-2.5 pr-14 nm-input rounded-lg text-xs font-semibold text-right"
//                   />
...
//                   placeholder={`Enter area in ${currentUnit}`}
//                   className="w-full px-3 py-2.5 pr-14 nm-input rounded-lg text-xs font-semibold text-right"
//                 />
...
//     // For Land & Room: Spec section -> Pricing -> Rest
//     if (baseSections[0]) activeSections.push(baseSections[0]);
//     activeSections.push(pricingSection);
//     for (let i = 1; i < baseSections.length; i++) {
//       activeSections.push(baseSections[i]);
//     }
//   } else if (propertyType === "Office Space" || propertyType === "Shop Space") {
//     // For Office & Shop: Config section -> Pricing -> Rest
//     if (baseSections[0]) activeSections.push(baseSections[0]);
//     activeSections.push(pricingSection);
//     for (let i = 1; i < baseSections.length; i++) {
//       activeSections.push(baseSections[i]);
//     }
//   } else {
//     // For House, Apartment, Flats: Basic Specs -> Area -> Pricing -> Rest
//     if (baseSections[0]) activeSections.push(baseSections[0]);
//     if (baseSections[1]) activeSections.push(baseSections[1]);
//     activeSections.push(pricingSection);
//     for (let i = 2; i < baseSections.length; i++) {
//       activeSections.push(baseSections[i]);
//     }
//   }
...
//           // Filter fields that evaluate to true based on their dependencies
//           const visibleFields = section.fields.filter(field => evaluateDependency(field.dependsOn, formData));

//           if (visibleFields.length === 0) return null;

//           return (
//             <div key={section.id} className="border-t border-[#A57C52]/20 pt-4">
//               <button
//                 type="button"
...
//               >
//                 <h3 className="text-xs font-black uppercase text-[#342417] tracking-wider">
//                   {section.title}
//                 </h3>
//                 {isExpanded ? (
...
//               {isExpanded && (
//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3 pl-0.5">
...
export function StepDetails({ formData, onChange, errors }: StepDetailsProps) {
  ...
  return (
    <div className="space-y-5 pb-6 select-none">
      ...
      <div className="sticky top-0 z-20 -mx-1 px-1 pb-2 bg-gradient-to-b from-[#F4ECD9] via-[#F4ECD9] to-transparent">
